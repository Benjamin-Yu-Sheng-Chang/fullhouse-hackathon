"""
Conservative baseline with short-stack jam/fold override.
...
CONFIG = {'equity_iterations': 75, 'open_late': 52, 'open_middle': 58, 'open_early': 64, 'continue_late': 64, 'continue_early': 72, 'premium_pair_rank': 10, 'value_equity': 0.62, 'raise_equity': 0.74, 'call_margin': 0.055, 'multiway_margin': 0.04, 'late_bluff_frequency': 0.16, 'steal_adjustment': 1, 'aggro_tighten': 4, 'short_stack_enabled': True, 'short_stack_bb': 18, 'short_stack_jam_score': 66, 'short_stack_call_score': 72, 'postflop_draw_raise_frequency': 0.15, 'value_bet_fraction': 0.6, 'pressure_bet_fraction': 0.42, 'raise_bet_fraction': 0.82}
