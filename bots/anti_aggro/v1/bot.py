"""
Tight trap/value strategy versus high raise-rate tables.
...
CONFIG = {'equity_iterations': 80, 'open_late': 54, 'open_middle': 60, 'open_early': 66, 'continue_late': 64, 'continue_early': 72, 'premium_pair_rank': 9, 'value_equity': 0.64, 'raise_equity': 0.76, 'call_margin': 0.06, 'multiway_margin': 0.045, 'late_bluff_frequency': 0.12, 'steal_adjustment': 2, 'aggro_tighten': 7, 'short_stack_enabled': False, 'short_stack_bb': 14, 'short_stack_jam_score': 72, 'short_stack_call_score': 76, 'postflop_draw_raise_frequency': 0.12, 'value_bet_fraction': 0.72, 'pressure_bet_fraction': 0.42, 'raise_bet_fraction': 0.95}
