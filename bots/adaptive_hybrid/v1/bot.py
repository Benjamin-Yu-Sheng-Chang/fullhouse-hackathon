"""
Hand equity, position, opponent profile, and stack mode.
...
CONFIG = {'equity_iterations': 85, 'open_late': 50, 'open_middle': 56, 'open_early': 62, 'continue_late': 60, 'continue_early': 68, 'premium_pair_rank': 10, 'value_equity': 0.6, 'raise_equity': 0.72, 'call_margin': 0.05, 'multiway_margin': 0.038, 'late_bluff_frequency': 0.24, 'steal_adjustment': 4, 'aggro_tighten': 5, 'short_stack_enabled': True, 'short_stack_bb': 15, 'short_stack_jam_score': 68, 'short_stack_call_score': 74, 'postflop_draw_raise_frequency': 0.22, 'value_bet_fraction': 0.64, 'pressure_bet_fraction': 0.48, 'raise_bet_fraction': 0.88}
