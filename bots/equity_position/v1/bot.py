"""
Equity guard core with position-aware opens and c-bets.
...
CONFIG = {'equity_iterations': 85, 'open_late': 48, 'open_middle': 54, 'open_early': 60, 'continue_late': 58, 'continue_early': 66, 'premium_pair_rank': 10, 'value_equity': 0.58, 'raise_equity': 0.7, 'call_margin': 0.045, 'multiway_margin': 0.035, 'late_bluff_frequency': 0.3, 'steal_adjustment': 0, 'aggro_tighten': 0, 'short_stack_enabled': False, 'short_stack_bb': 14, 'short_stack_jam_score': 69, 'short_stack_call_score': 74, 'postflop_draw_raise_frequency': 0.25, 'value_bet_fraction': 0.62, 'pressure_bet_fraction': 0.5, 'raise_bet_fraction': 0.85}
