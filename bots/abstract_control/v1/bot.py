"""Abstract Control v1: abstraction-driven pot control and disciplined calls."""
import random
from collections import Counter

import eval7

BOT_NAME = "Abstract Control v1"
BIG_BLIND = 100
RANKS = "23456789TJQKA"
...
CONFIG = {
    ...
    "thin_value_pair": False,
    "pressure_frequency": 0.04,
}
...
def _postflop(state, features):
    ...
    if owed == 0:
        if texture["made"] == "strong" or equity >= CONFIG["value_equity"]:
            return {"action": "raise", "amount": _bet_to(state, 0.56 if not texture["board_danger"] else 0.42)}
