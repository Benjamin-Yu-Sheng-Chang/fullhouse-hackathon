...
CONFIG = {
    ...
    "river_extra_margin": 0.045,
    "large_bet_extra_margin": 0.075,
    "expensive_price_margin": 0.035,
}
...
def _postflop_policy(state, features):
    ...
    if features["pot_price"]["label"] == "expensive" and texture["made"] != "strong":
        margin += CONFIG["expensive_price_margin"]
